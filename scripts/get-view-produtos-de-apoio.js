// Importar as funções de exclusão e envio de notificações
          ...
          <div class="panel-title">
            ...
            <ul class="panel-tools">
                <li><a style="border: 1px solid blue;" href="#" type="button" class="btn btn-square btn-light ">Editar</a></li>
                 <li><a style="border: 1px solid red;" href="#" type="button" class="btn btn-rounded btn-light btn-icon delete-product" data-product-id="${product.ID}" data-product-name="${product.Nome}"><i class="fa fa-trash"></i></a></li>
            </ul>
          </div>
          <div class="panel-body">
