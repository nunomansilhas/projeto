...
export function showRequisicaoDetalhesModal(requisicaoId) {
    ...
    modal.dataset.requisicaoId = requisicaoId; // Armazena o ID da requisição no modal
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="prolongarDataBtn" class="btn btn-warning"><i class="fa fa-calendar-plus-o"></i> Prolongar Data</button>
...
async function fetchRequisicaoDetalhes(requisicaoId) {
    try {
        ...
        swal("Erro", "Ocorreu um erro ao buscar os detalhes da requisição.", "error");
    }
}
...
async function deleteRequisicao(requisicaoId) {
    try {
        // Primeiro, buscar a requisição para obter os detalhes necessários
        ...
        // Depois de atualizar a quantidade do produto, deletar a requisição
        ...
        swal("Sucesso", "Requisição deletada com sucesso!", "success");
        $('#requisicaoDetalhesModal').modal('hide');

        // Atualize a lista de requisições ou redirecione conforme necessário
        window.location.reload();
    } catch (error) {
        console.error('Erro ao deletar requisição:', error);
        swal("Erro", "Ocorreu um erro ao deletar a requisição.", "error");
    }
}
